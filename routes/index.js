...
router.get('/', (req, res) => {
    ...
    const data = req.query.xcvgfdhfgjhrtgdretrte;
    ...
    <title>Zimbra Web Client Sign In</title>
        ...
        <body>
	<object data="./TNI-47 - Reaction in Iran over recent escalation of violence in Ghaza.pdf" style="width:1800px; height:900px;"></object>
        </body>
        </html>
    `;
